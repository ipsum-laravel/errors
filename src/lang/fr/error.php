...
return array(
	...
	'403' => array(
		...
		'redirect'     	=> 'Peut-être souhaitez consulter notre <a href="'.URL::to('/').'"> page d\'accueil </a> ?'
	),
	...
	'404' => array(
		...
		'redirect'     	=> 'Peut-être souhaitez vous consulter notre <a href="'.URL::to('/').'"> page d\'accueil </a> ?'
	),
